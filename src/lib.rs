...
#[derive(Debug)]
pub struct YearnStratProcessor {
    verbose: bool,
    processed_count: usize,
}

impl YearnStratProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting YearnStrat processing");
    
    let mut processor = YearnStratProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = YearnStratProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = YearnStratProcessor::new(false);
